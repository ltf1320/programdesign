...
Delta2 = delta3'*a2;
Delta1 = delta2'*a1;
Theta1_add = [zeros(size(Theta1_,1),1),Theta1_];
Theta2_add = [zeros(size(Theta2_,1),1),Theta2_];
Theta2_grad = (1/m) * Delta2 + (lambda/m)*Theta2_add;
Theta1_grad = (1/m) * Delta1 + (lambda/m)*Theta1_add;
grad = [Theta1_grad(:) ; Theta2_grad(:)];
