...
SQLQuery qu=ses.createSQLQuery("select * from message where cl1='电子竞技' order by createTime desc").addEntity(Message.class);
...
<html>
  <head>
    ...
    <title>My JSP 'e-sports.jsp' starting page</title>
