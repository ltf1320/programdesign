...
SQLQuery qu=ses.createSQLQuery("select * from message where cl1='吃喝玩乐' order by createTime desc").addEntity(Message.class);
...
<html>
  <head>
    ...
    <title>My JSP 'plays.jsp' starting page</title>
