...
SQLQuery qu=ses.createSQLQuery("select * from message where cl1='体育运动' order by createTime desc").addEntity(Message.class);
...
<html>
  <head>
    ...
    <title>My JSP 'sports.jsp' starting page</title>
