...
public abstract class AbstractMessage implements java.io.Serializable {
	...
	/** minimal constructor */
	public AbstractMessage(Users users, String cl1, Timestamp createTime,
			String title) {
		this.users = users;
		this.cl1 = cl1;
	...
	/** full constructor */
	public AbstractMessage(Users users, String cl1, String cl2,
			Timestamp createTime, String time, String title, String text,
