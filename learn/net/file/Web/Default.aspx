...
<form id="form1" runat="server">
   ...
   <div style="text-align:center; margin:5px 0px;">Copyright (C) John+Fox. All rights reserved. <a href="http://iusers.com.cn" title="iUsers.com.cn" target="_blank">iUsers.com.cn</a>+<a href="http://Foxtk.cnblogs.com" title="Foxtk.cnblogs.com" target="_blank">Foxtk.cnblogs.com</a> <%=new FileManager.FileSystemItem().Version()%></div> 
</form>
</body>
</html>