...
public:
    ...
    void setupUi(QWidget *FindFileForm)
    {
        ...
        label_3 = new QLabel(FindFileForm);
        label_3->setObjectName(QStringLiteral("label_3"));

        gridLayout->addWidget(label_3, 2, 0, 1, 1);

        dirComboBox = new QComboBox(FindFileForm);
        dirComboBox->setObjectName(QStringLiteral("dirComboBox"));

        gridLayout->addWidget(dirComboBox, 2, 1, 1, 1);

        browsePushBtn = new QPushButton(FindFileForm);
        ...
        splitter_4 = new QSplitter(FindFileForm);
        splitter_4->setObjectName(QStringLiteral("splitter_4"));
        splitter_4->setOrientation(Qt::Horizontal);
        statusLabel = new QLabel(splitter_4);
        ...
        splitter_4->addWidget(statusLabel);
        resultLabel = new QLabel(splitter_4);
        ...
        splitter_4->addWidget(resultLabel);
    ...
    void retranslateUi(QWidget *FindFileForm)
    {
        ...
        resultLabel->setText(QApplication::translate("FindFileForm", "\346\237\245\346\211\276\347\273\223\346\236\234", 0));
    } // retranslateUi
