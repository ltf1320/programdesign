...
namespace TradeLink.AppKit
{
    public partial class GenericView<T> : UserControl, GenericViewI where T : Model
    {
        ...
        protected GenericViewItem<T> _gvi = null;
        ...
        protected virtual bool updaterow(int dtrow_or_modidx, T model)
        {
            ...
            {
                v("error occured updating row: " + dtrow_or_modidx + " with: " + model.ToString());
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual string[] getsymbols_popup() { return getsymbols_popup(true); }
        /// <summary>
        /// get a popup prompting user for symbols, control whether lowercase allowed
        /// </summary>
        /// <param name="toupper"></param>
        /// <returns></returns>
        protected virtual string[] getsymbols_popup(bool toupper)
        {
            // get list of symbols
        ...
        protected string _ex = string.Empty;
        public string DefaultDestination { get { return _ex; } set { _ex = value; } }

        protected string _account = string.Empty;
        public string DefaultAccount { get { return _account; } set { _account = value; } }
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual string[] getsymbols_file()
        {
        ...
        void initformat(int[] modformats, string[] formats)
        {
            if (dv.InvokeRequired)
        ...
        protected virtual void doubleclick(int r, int c)
        {
        }
        ...
        void dvupdategridcell(int r, int c)
        {
        ...
        public List<string> getselectedsymbols() { return selectedsymbols<T>(this.dv, models); }

        public static List<string> selectedsymbols<T>(DataGridView dg, List<T> noms) where T : Model
        {
            List<string> syms = new List<string>();
        ...
        protected int gridrow2tablerow(int disprow) 
        { 
        ...
        protected int[] selectedrowsdisp()
        {
