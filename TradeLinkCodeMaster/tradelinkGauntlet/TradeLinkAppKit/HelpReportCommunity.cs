...
namespace TradeLink.AppKit
{
    ...
    public class HelpReportCommunity
    {
        ...
        {
            string id = TradeLink.Common.Util.TLVersion();
            return "mailto://" + CommunityEmail + "?subject=" + string2urlparams(program+" Community Help "+id, null) + "&body=" + string2urlparams(HelpBody(err), null);
        }
